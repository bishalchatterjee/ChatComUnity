...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messagesArrayList = new ArrayList<>();
                adater = new MessagesAdater(com.bishal.chatcomunity.ChatActivity.this, messagesArrayList);
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (message.isEmpty()) {
                    Toast.makeText(com.bishal.chatcomunity.ChatActivity.this, "Please enter Valid Message", Toast.LENGTH_SHORT).show();
                    return;
                }
                edtMessage.setText("");
                Date date = new Date();
