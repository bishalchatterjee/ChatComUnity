                                    ...
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful())
                                            {
                                                ...
                                                Toast.makeText(com.bishal.chatcomunity.SettingActivity.this, "Data Successfully Updated", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(com.bishal.chatcomunity.SettingActivity.this, com.bishal.chatcomunity.HomeActivity.class));
                                            }
                                            else {
                                                 progressDialog.dismiss();

                                                Toast.makeText(com.bishal.chatcomunity.SettingActivity.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                                }
